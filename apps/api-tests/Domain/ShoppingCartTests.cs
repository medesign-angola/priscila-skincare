...
public sealed class ShoppingCartTests
{
    ...
    public void Add_MergesSameSkuAndVariant()
    {
        ...
        cart.Add(CommerceItemType.Product, CommerceItemReference.Create("SNOW-001"), "500ml", "500 ml", 1, DateTimeOffset.UtcNow);
        cart.Add(CommerceItemType.Product, CommerceItemReference.Create("SNOW-001"), "500ml", "500 ml", 2, DateTimeOffset.UtcNow);
    ...
    {
        var cart = ShoppingCart.Create(Guid.NewGuid(), DateTimeOffset.UtcNow);
        cart.Add(CommerceItemType.Product, CommerceItemReference.Create("SNOW-001"), null, null, 1, DateTimeOffset.UtcNow);
