...
public sealed class OrderTests
{
    ...
    public void AddItem_KeepsCommercialSnapshot()
    {
        ...
        order.AddItem(
            CommerceItemType.Product,
            CommerceItemReference.Create("SNOW-001"),
            "Snow White Soap",
            "150G",
        ...
        Assert.Equal("SNOW-001", item.Reference.Value);
    ...
    public void Create_KeepsAddressAndTotalSnapshots()
    {
        ...
        order.AddItem(CommerceItemType.Product, CommerceItemReference.Create("SNOW-001"), "Snow White", "500 ml", Money.Create(10_000, "AOA"), 2);
    ...
    public void ChangeStatus_RejectsBackwardTransition()
    {
        ...
        order.ChangeStatus(OrderStatus.Paid, DateTimeOffset.UtcNow);
