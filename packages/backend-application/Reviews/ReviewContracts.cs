...
public sealed record ReviewResult(Guid Id, string ProductSku, string Name, int Rating, string Title, string Comment, bool Recommends, string Status, DateTimeOffset CreatedAt, DateTimeOffset UpdatedAt, DateTimeOffset? EditedAt, DateTimeOffset? ModeratedAt);
